...
public class PaperDisplayer : MonoBehaviour
{
    ...
    public void RenderPaperFirstTime(PaperDefinition paper)
    {
        ...
        if (index >= 0)
        {
            RenderPaper(Issues[index], CloseButtons[index], paper);
        }
    }

    private void RenderPaper(GameObject Issue, Button Close, PaperDefinition paper)
    {
        ...
        {
            if (paper.ShouldTriggerNextEventWhenRead)
            {
